...
WEBHOOK_ASYNC_LEGACY_MODE = get_bool_from_env("WEBHOOK_ASYNC_LEGACY_MODE", True)
WEBHOOK_ASYNC_BATCH_SIZE = int(os.environ.get("WEBHOOK_ASYNC_BATCH_SIZE", 100))
WEBHOOK_ASYNC_BATCH_TIMEOUT = int(os.environ.get("WEBHOOK_ASYNC_BATCH_TIMEOUT", 30))
WEBHOOK_ASYNC_MAX_CONCURRENCY = int(os.environ.get("WEBHOOK_ASYNC_MAX_CONCURRENCY", 10))
